...
try
    dy = [-0.877*y(1) + y(3) - 0.088*y(1)*y(3) + 0.47*y(1)^2 - 0.019*y(2)^2...
          - y(1)^2*y(3) + 3.846*y(1)^3 - 0.215*u + 0.28*y(1)^2*u + 0.63*u^3 +...
          0.47*y(1)*u^2;
          
          y(3);
          
          -4.208*y(1) - 0.396*y(3) - 0.47*y(1)^2 - 3.564*y(1)^3 - ...
          20.967*u + 46*y(1)*u^2 + 61.4*u^3 + 6.265*y(1)^2*u]; %
catch
    keyboard
end
